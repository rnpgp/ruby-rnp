...
Documentation is available on https://www.rubydoc.info/github/riboseinc/ruby-rnp/master/[RubyDoc].

== Requirements

This gem currently requires https://github.com/riboseinc/rnp[librnp] 0.10.0 or newer.
